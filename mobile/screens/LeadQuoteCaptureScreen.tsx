...
import { DEMO_BUSINESS_CATEGORY, DEMO_BUSINESS_LINE } from '../src/config/demoIdentity';
...
export const LeadQuoteCaptureScreen = () => {
    const route = useRoute<any>();
    const navigation = useNavigation<any>();
    const sourcePostId = route.params?.postId || '';
    ...
    const [sourcePost, setSourcePost] = useState(sourcePostId);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const payload = {
                ...
                business_category_key: DEMO_BUSINESS_CATEGORY,
                business_line: DEMO_BUSINESS_LINE,
                post_id: sourcePost || undefined,
        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
                ...
                <View style={styles.formCard}>
                    ...
                    <TextInput style={styles.input} value={sourcePost} onChangeText={setSourcePost} placeholder="e.g. CPT-1024" />
                ...
                <View style={styles.boundaryBox}>
                    <Text style={styles.boundaryText}>
                        Lead capture is not sale confirmation. Quote request is not policy approval. Commission is not earned until downstream evidence exists.
                    </Text>
                </View>
            </ScrollView>
        </View>
