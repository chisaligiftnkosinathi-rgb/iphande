...
EVENT_LABELS = {
    ...
    "followup_created": "Operational follow-up planned",
    "followup_amended": "Operational follow-up updated",
    "steward_annotation_added": "Compliance annotation added",
...
EVENT_BOUNDARIES = {
    ...
    "payment_under_review": "Pending operational review.",
    ...
    "opportunity_created": "Merchant identified an emerging intent.",
    "opportunity_amended": "Opportunity record was structurally amended.",
    "followup_created": "Scheduled a continuity response.",
    "followup_amended": "Follow-up record was structurally amended.",
    "steward_annotation_added": "Interpreted the continuity.",
    ...
    "content_draft_approved": "Finalized and approved the intent.",
    "content_draft_rejected": "Rejected the provisional assistance.",
    "system_interpretation_corrected": "Corrected a provisional system interpretation.",
}
